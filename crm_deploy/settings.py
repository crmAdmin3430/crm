"""
Django settings for crm_deploy project.
...
SECRET_KEY = 'django-insecure-xdd=wx6%1dao#!m6ucaf8f1-0vl!#z3wr!+xwvdh2r)@t$@dhz'
...
WSGI_APPLICATION = 'crm_deploy.wsgi.application'
